  ...
  return (
    <div className="cart-section bg-slate-50 min-h-screen py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <h1 className="text-2xl font-black text-slate-900 tracking-tight mb-6">Shopping Cart</h1>
        ...
        {cartWithData.length === 0 ? (
          <div className="bg-white border border-slate-200 border-dashed rounded-2xl p-12 text-center flex flex-col items-center max-w-lg mx-auto">
            ...
            <h3 className="text-base font-bold text-slate-800 mb-1">Your cart is completely empty</h3>
                ...
                {appliedCoupon ? (
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="mt-1 pt-1 border-t border-slate-50">
                      <span className="text-[10px] font-bold text-slate-405 block mb-1">Available Coupons:</span>
